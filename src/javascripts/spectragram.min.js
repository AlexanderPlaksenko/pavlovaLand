...
(function ($, window, document, undefined) {
    var Instagram = {
        API_URL: "https://api.instagram.com/v1", initialize: function (options, elem) {
            this.elem = elem;
            this.$elem = $(elem);
            ...
            var self = this, getData = "/users/" + userID + "/media/recent/?" + self.userCredentials;
            ...
            var self = this, getData = "/media/popular?client_id=" + self.userCredentials;
            self.fetch(getData).done(function (results) {
                self.display(results)
            })
            ...
            var $element, $image, isWrapperEmpty, imageGroup = [], imageCaption, imageHeight, imageWidth, max, setSize,
                size;
            ...
            if (results.data === undefined || results.meta.code !== 200 || results.data.length === 0) {
                ...
                for (var i = 0; i < max; i++) {
                    ...
                    $image = $("<img>", {alt: imageCaption, attr: {height: imageHeight, width: imageWidth}, src: size});
                    $element = $("<a>", {
